...
<button type="button" class="btn btn-primary mb-2" onclick="frmCaja()"><i class="fa fa-plus"></i></button>
<!-- Vista de las tablas -->
...
<div class="modal fade" id="nuevo_cajas" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
