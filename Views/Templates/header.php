...
<html lang="en">
    <head>
        ...
        <link href="<?php echo base_url; ?>Assets/css/datastyle.css" rel="stylesheet" />
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.html">Shopify EX</a>
            <!-- Sidebar Toggle-->
            ...
            <ul class="navbar-nav ms-auto me-3 me-lg-4">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        ...
                        <li><a class="dropdown-item" href="<?php echo base_url; ?>Usuarios/salir">Cerrar Session</a></li>
                    </ul>
                </li>
            </ul>
        </nav>
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="<?php echo base_url; ?>Cajas"><i class="fa fa-archive me-2"></i>Cajas</a>
                                </nav>
                            </div>
